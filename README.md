...
- [Discrete distributions](discrete)
    - [Poisson distribution](discrete/poisson)
        - [Knuth-Junhao's method](discrete/poisson/knuth-junhao)
- [Distributions with density](continuous)
    - [Approximation](continuous/approximation)
        - [Importance sampling](continuous/approximation/importance_sampling)
